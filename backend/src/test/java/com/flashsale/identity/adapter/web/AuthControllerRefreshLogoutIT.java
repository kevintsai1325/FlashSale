...
class AuthControllerRefreshLogoutIT extends AbstractIntegrationTest {
    ...
    @Test
    void validRefreshCookieIssuesNewAccessToken() throws Exception {
        Cookie refreshCookie = registerAndLogin("gina@example.com", "secret123");
    ...
    void logoutRevokesRefreshTokenSoSubsequentRefreshFails() throws Exception {
        Cookie refreshCookie = registerAndLogin("hank@example.com", "secret123");
