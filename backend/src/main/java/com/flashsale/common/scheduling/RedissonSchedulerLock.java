...
/**
 * {@link SchedulerLock} 的 Redisson 實作，本專案的預設選擇。
 *
 ...
 */
@Component
// 預設實作。以 app.scheduling.lock=kubernetes 可切換到 KubernetesLeaseSchedulerLock 做對照。
@ConditionalOnProperty(name = "app.scheduling.lock", havingValue = "redisson", matchIfMissing = true)
public class RedissonSchedulerLock implements SchedulerLock {
    ...
    public RedissonSchedulerLock(RedissonClient redissonClient, MeterRegistry meterRegistry) {
