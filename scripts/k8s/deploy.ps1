...
foreach ($name in @('backend', 'purchase-service', 'order-service', 'analytics-service', 'frontend', 'nginx')) {
...
foreach ($name in @('backend', 'purchase-service', 'order-service', 'analytics-service', 'frontend', 'nginx')) { Wait-ForRollout "deployment/$name" }
